...
describe('Service Tests', () => {
    ...
    describe('CloudMeuConfiguration Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CloudMeuConfigurationService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/cloud-meu-configurations';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return CloudMeuConfiguration', () => {
